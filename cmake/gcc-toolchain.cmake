...
set(COMMON_CFLAGS "${MCU_CFLAGS} -ffunction-sections -fdata-sections -Wall -Wextra -Werror -Wshadow -Wmissing-include-dirs")
# Assume that PROJECT_NAME == executable name for consistency
set(
    COMMON_LFLAGS
    "-T${CMAKE_SOURCE_DIR}/linker/STM32F429ZITx_FLASH.ld -Wl,--gc-sections -Xlinker -Map=${PROJECT_NAME}.map -specs=nosys.specs")
